...
Usage: #example
Description: "Bundle 健診検査結果報告書　サンプル０１ 心電図をComponentで記述　Bundle　ProfileとCompositon Profileにバージョンを付与した例"
...
* entry[=].resource = Inline-Instance-for-1-Composition-with-Profile-Version
