...
,,50,生化学検査,330,3F015000002327201,空腹時中性脂肪(トリグリセリド)(トリグリセリド),数字,PQ,5,NNNNN,mg/dl,mg/dL,,,,3F015,中性脂肪（トリグリセリド）,3F01520000,2：紫外吸光光度法(酵素比色法・グリセロール消去),,1.2.392.200119.6.1005,V4.0でXML表示名変更,,,
