...
* component[0].code = $jlac10#9A751000000000001 "収縮期血圧（１回目）"
* component[=].valueQuantity = 149 'mm[Hg]' "mmHg"
* component[=].interpretation = $v3-ObservationInterpretation#N
* component[=].method.coding.system = "urn:oid:1.2.392.200119.6.1007"
* component[=].method.coding.code = "9A75100000"
* component[=].method.coding.display = "１回目"
* component[=].referenceRange.low = 80 'mm[Hg]' "mmHg"
* component[=].referenceRange.high = 130 'mm[Hg]' "mmHg"
* component[+].code = $jlac10#9A761000000000001 "拡張期血圧（１回目）"
* component[=].valueQuantity = 90 'mm[Hg]' "mmHg"
* component[=].interpretation = $v3-ObservationInterpretation#N
* component[=].method.coding.system = "urn:oid:1.2.392.200119.6.1007"
* component[=].method.coding.code = "9A76100000"
* component[=].method.coding.display = "１回目"
